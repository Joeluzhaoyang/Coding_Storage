            ...
            case "reverse":
                ...
                **/
                ...
                for(var c = 0; c < channels.length; ++c) {
                    ...
                    var temp;
                    for (var i = 0; i < (audioSequence.data.length - 1)/2; ++i) {
                ...
                for(var c = 0; c < channels.length; ++c) {
                    ...
                    for(var i = 0; i < audioSequence.data.length; ++i) {
                        ...
                        if(i <= attackDuration && i >= 0){
                            ...
                            audioSequence.data[i] *= lerp(sustainLevel, 0, (releaseDuration-(6*sampleRate-i)) / releaseDuration);
                ...
                **/
                ...
                for(var c = 0; c < channels.length; ++c) {
                    ...
                    for (var i = 0; i < audioSequence.data.length; ++i){
                        ...
                        var multiX = (Math.sin(2*Math.PI*tremoloFrequency*currentTime-Math.PI/2)+1)/2;
                        multiX = multiX * wetness + (1- wetness);
                        audioSequence.data[i] *= multiX;
                    }
                    // Update the sample data with the post-processed data
                    channels[c].setAudioSequence(audioSequence);
                }
