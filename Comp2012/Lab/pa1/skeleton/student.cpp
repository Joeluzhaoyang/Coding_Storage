...
:student_id(student_id), gpa(gpa), max_credit(STUDENT_INIT_MAX_CREDIT),
curr_credit(0),num_enrolled_course(0), pending_credit(0)
{
    // TODO
...
:student_id(student.student_id), gpa(student.gpa), max_credit(STUDENT_INIT_MAX_CREDIT),
curr_credit(student.curr_credit),num_enrolled_course(student.num_enrolled_course), pending_credit(student.pending_credit)
{
    // TODO
    ...
    for(int i = 0 ; i<STUDENT_MAX_NUM_COURSE ; i++)
    {
        ...
        else{this->enrolled_courses[i] = nullptr;}
    }
