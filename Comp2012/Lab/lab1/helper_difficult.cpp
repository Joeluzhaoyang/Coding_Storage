...
void init_monster(Monster_Map* const monster_map){
    monster_map->set_monster(2, 2, new Monster("A", 500, 20, 30, 30, 2, 2, 7, ICE));
    monster_map->set_monster(2, 4, new Monster("B", 500, 20, 30, 30, 4, 2, 7, ICE));
    monster_map->set_monster(3, 3, new Monster("C", 500, 20, 30, 30, 3, 3, 7, ICE));
    monster_map->set_monster(5, 5, new Monster("D", 500, 20, 30, 30, 5, 5, 7, ICE));
    monster_map->set_monster(4, 2, new Monster("E", 500, 20, 30, 30, 2, 4, 7, ICE));
}
