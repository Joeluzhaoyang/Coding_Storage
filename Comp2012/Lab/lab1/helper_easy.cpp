...
void init_monster(Monster_Map* const monster_map){
    monster_map->set_monster(2, 2, new Monster("A1", 200, 10, 15, 15, 2, 2, 3, FIRE));
    monster_map->set_monster(2, 4, new Monster("A2", 200, 10, 15, 15, 4, 2, 3, FIRE));
    monster_map->set_monster(3, 3, new Monster("A3", 200, 10, 15, 15, 3, 3, 3, FIRE));
    monster_map->set_monster(5, 5, new Monster("A4", 200, 10, 15, 15, 5, 5, 3, FIRE));
    monster_map->set_monster(4, 2, new Monster("A5", 200, 10, 15, 15, 2, 4, 3, FIRE));
}
